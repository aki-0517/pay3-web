...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'link.share': 'Share',
    'link.shareTitle': 'Share Crypto Link',
    'link.email': 'Email',
    'link.message': 'Message',
    'link.copyLink': 'Copy Link',
    'link.copied': 'Link copied to clipboard',
    'link.twitterShareText': 'I sent you crypto! Claim it with this link (ID: {id})',
    'link.emailSubject': 'You received crypto',
    'link.emailBody': 'I sent you crypto! (ID: {id})\nClaim it with this link: {url}',
    'link.shareText': 'I sent you crypto! Claim it with this link (ID: {id})',
    'link.shareSuccess': 'Shared successfully',
    'link.shareFailed': 'Failed to share',
  ...
  ja: {
    ...
    'link.share': 'シェア',
    'link.shareTitle': '暗号通貨リンクを共有',
    'link.email': 'メール',
    'link.message': 'メッセージ',
    'link.copyLink': 'リンクをコピー',
    'link.copied': 'リンクがクリップボードにコピーされました',
    'link.twitterShareText': '暗号通貨を送りました！このリンクで受け取ってください（ID: {id}）',
    'link.emailSubject': '暗号通貨を受け取りました',
    'link.emailBody': '暗号通貨を送りました！（ID: {id}）\nこのリンクから受け取ってください: {url}',
    'link.shareText': '暗号通貨を送りました！このリンクで受け取ってください（ID: {id}）',
    'link.shareSuccess': '共有に成功',
    'link.shareFailed': '共有に失敗',
